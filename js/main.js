$(window).on("load", function() {
    ...
    o(), t.resize(o), $.scrollIt({
        ...
        function() {
            ...
            Email.send({
                Host: "smtp.gmail.com",
                Username : "testkashish769@gmail.com",
                Password : "Kashish@sol769!",
                To : 'kashishsolanki769@gmail.com',
                From : email,
                Subject : "Contacted by Portfolio site",
                Body : message,
            }).then(
                message => alert("Mail sent successfully with your message, Thank you!")
            ).catch(
                error => alert(error)
            )
